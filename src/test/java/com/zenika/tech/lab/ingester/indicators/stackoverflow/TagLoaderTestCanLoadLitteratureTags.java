 ...
 */
@QuarkusTest
@TestProfile(TagLoaderTestCanLoadLitteratureTags.Configuration.class)
class TagLoaderTestCanLoadLitteratureTags extends CamelQuarkusTestSupport {
...
"quarkus.camel.routes-discovery.include-patterns", ".*"+TagLoader.class.getSimpleName()
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                	...
                	.to("mock:TagLoaderTestCanLoadLitteratureTags")
                    .end();
            }
        };
    }
	
	@EndpointInject("mock:TagLoaderTestCanLoadLitteratureTags")
	...
	@Test
	void can_load_tags_from_litterature() throws InterruptedException {
		// Given
